...
{
    public partial class Employees_ViewForm : Form
    {
        ...
        {
            new Employees_AddEditForm(DBT_Employees.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Employees_AddEditForm().ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Employees.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
            res = DBT_Auth.Remove(DBT_Auth.GetByEmployeeID((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value).AuthID);
                ...
                using (var query = connection.CreateCommand())
                {
                    ...
                    using (var reader = query.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            dataGridView.Rows[index].Cells[5].Value = DBT_Auth.GetByEmployeeID(reader.GetInt32(0)).Login;
